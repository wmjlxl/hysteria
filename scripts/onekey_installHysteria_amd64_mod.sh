...
mkdir hysteria
cd ./hysteria
wget https://github.com/HyNetwork/hysteria/releases/download/v1.1.0/hysteria-linux-amd64
...
cat > ./client.json <<EOF
{
    ...
    "auth_str": "${password}",
    "insecure": true,
    "recv_window_conn": 31457280,
    "recv_window": 125829120,
